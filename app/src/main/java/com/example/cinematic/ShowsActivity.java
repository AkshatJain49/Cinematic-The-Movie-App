                ...
                if(query.isEmpty())
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            try {
                                DownloadJSON downloadNowPlayingJSON = new DownloadJSON();
                                String data = downloadNowPlayingJSON.execute("https://api.themoviedb.org/3/search/tv?api_key=83b2f8791807db4f499f4633fca4af79&language=en-US&page=1&query=" + query).get();
                                getData(data);
                            }
                            catch (Exception e) {
                                e.printStackTrace();
